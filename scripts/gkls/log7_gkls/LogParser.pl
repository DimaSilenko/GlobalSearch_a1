...
else
{
	print "create new\n";
	open(W, ">comm.csv");
	##print W "TaskNumber;N;FuncNumber;eps;r;dist;radius;num_minima;min;IsSolvePerebor;timePerebor;IterPerebor;IsSolveAGP;timeAGP;IterAGP;\n";
	print W "TaskNumber;N;FuncNumber;eps;r;dist;radius;num_minima;min;IsSolveAGP;timeAGP;IterAGP;\n";
}
